            ...
            <div class="card-body">
                ...
                <form action="dataHandler" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="textl" class="form-control" placeholder="Username" name="username" required>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button class="btn btn-outline-primary btn-block" onclick="window.location.href='register'">Register as New Reader</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
